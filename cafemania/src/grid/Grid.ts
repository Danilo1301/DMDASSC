...
export class Grid
{
    ...
    public getCoordsItemOcuppes(cell: Cell, size: Phaser.Math.Vector2, changeRotation: boolean, flipCells: boolean): Phaser.Math.Vector2[]
    {
    ...
    public static getOffsetCoordsItemOcuppes(itemSize: Phaser.Math.Vector2, changeRotation: boolean, flipCells: boolean): Phaser.Math.Vector2[][]
    {
