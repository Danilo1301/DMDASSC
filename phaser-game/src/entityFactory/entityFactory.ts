...
export class EntityFactory
{
    ...
    constructor(entityManager: EntityManager, world: World)
    {
        ...
        Network.Events.on('received_packet:entity_stream_in', this.ProcessEventEntityStreamIn, this)
        Network.Events.on('received_packet:entity_data', this.ProcessEventEntityData, this)
        Network.Events.on('received_packet:entity_stream_out', this.ProcessEventEntityStreamOut, this) 
    }
    ...
    public ProcessEventEntityStreamIn(data: PacketDataEntity)
    {
    ...
    public ProcessEventEntityData(data: PacketDataEntity)
    {
    ...
    public ProcessEventEntityStreamOut(entityId: string)
    {
